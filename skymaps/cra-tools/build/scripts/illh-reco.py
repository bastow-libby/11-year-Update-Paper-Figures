...
if __name__ == "__main__":
    ...
    p.add_argument('-o', '--outdir', dest='outdir',
            default='/home/ebastow/11-year-Update-Paper-Figures/skymaps/cra-tools/build/maps',
    ...
    p.add_argument('--submit_dir', dest='submit_dir',
            default='/home/ebastow/11-year-Update-Paper-Figures/skymaps/cra-tools/build/submit-dir',
    ...
    for degbin in range(0,360):
        ...
        cmd  = '/home/ebastow/11-year-Update-Paper-Figures/skymaps/cra-tools/build/bin/combine-local-maps' 
