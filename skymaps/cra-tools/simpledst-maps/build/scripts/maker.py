...
if __name__ == "__main__":
    ...
    p.add_argument('-o', '--outDir', dest='outDir',
            default='/home/amcclure/11-year-Update-Paper-Figures/skymaps/cra-tools/simpledst-maps/build/maps',
    ...
    p.add_argument('--submit_dir', dest='submit_dir',
            default='/home/amcclure/11-year-Update-Paper-Figures/skymaps/cra-tools/simpledst-maps/build/submit-dir',
    ...
    batchPrefix = '/home/amcclure/11-year-Update-Paper-Figures/skymaps/cra-tools/simpledst-maps/build/tempFiles'
    ...
    validArgs += ['spline','batchFile','sd','sd2']
    ...
    for i in range(len(dayFiles)):
        ...
        cmd  = '/home/amcclure/11-year-Update-Paper-Figures/skymaps/cra-tools/simpledst-maps/build/bin/TimeScramble' 
