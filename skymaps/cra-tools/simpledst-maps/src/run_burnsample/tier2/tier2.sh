...
function run_makemaps {
    ...
    command="python ../../scripts/make-local-maps-IT.py.in -c ITpass2 -o /data/user/@USER@/.../tier2 $options"
    $command
...
options_per_year[2012]="-d 20120513 20130512 -i --smin 5 --smax 9 --submit_dir ./submit_2012"
