...
function run_makemaps {
    ...
    #command="python ../../scripts/make-local-maps-IT.py.in -c ITpass2 -o /data/user/amcclure/fitsfilesalltiers/tier1_unblinded2 $options"
    #$command
     command="python ../../scripts/make-local-maps-IT.py.in -c ITpass2 -o /data/ana/CosmicRay/Anisotropy/IceTop/ITpass2/output/outputa/tier1_unblinded $options"
     $command
