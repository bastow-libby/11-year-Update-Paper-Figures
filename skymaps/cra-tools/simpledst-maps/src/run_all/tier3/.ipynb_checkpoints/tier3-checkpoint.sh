...
function run_makemaps {
   ...
   #command="python ../../scripts/make-local-maps-IT.py.in -c ITpass2 -o /data/user/amcclure/fitsfilesalltiers/tier3_unblinded2 $options"
    command="python ../../scripts/make-local-maps-IT.py.in -c ITpass2 -o /data/ana/CosmicRay/Anisotropy/IceTop/ITpass2/output/outpute/alexfits/tier3 $options"
    $command
