...
def tier_two(out_dir, dec_min=-90.0, dec_max=-35.0, smoothing_angle=20,
    ...
    Saves pngs in specified output directory.
    """
    combined = hp.read_map("./fits/combined_t2_iteration20.fits.gz")
    variance = hp.read_map("./fits/significance_t2_iteration20.fits.gz")
    ...
    if range_ri[0] == 0 and range_ri[1] == 0:
        ...
        relative_intensity(combined, title, dec_min, dec_max, smoothing_angle,
                           out_dir + "t2_rel_int.png", min=range_ri[0],
                           max=range_ri[1])
    ...
    if range_sig[0] == 0 and range_sig[1] == 0:
        ...
        li_ma_significance(combined, variance, title, dec_min, dec_max,
                           smoothing_angle, out_dir + "t2_sig.png",
                           min=range_sig[0], max=range_sig[1])
...
def tier_three(out_dir, dec_min=-90.0, dec_max=-35.0, smoothing_angle=20,
    ...
    Saves pngs in specified output directory.
    """
    combined = hp.read_map("./fits/combined_t3_iteration20.fits.gz")
    variance = hp.read_map("./fits/significance_t3_iteration20.fits.gz")
    ...
    if range_ri[0] == 0 and range_ri[1] == 0:
        ...
        relative_intensity(combined, title, dec_min, dec_max, smoothing_angle,
                           out_dir + "t3_rel_int.png", min=range_ri[0],
                           max=range_ri[1])
...
def tier_four(out_dir, dec_min=-90.0, dec_max=-35.0, smoothing_angle=20,
    ...
    Saves pngs in specified output directory.
    """
    combined = hp.read_map("./fits/combined_t4_iteration20.fits.gz")
    variance = hp.read_map("./fits/significance_t4_iteration20.fits.gz")
    ...
    if range_ri[0] == 0 and range_ri[1] == 0:
        ...
        relative_intensity(combined, title, dec_min, dec_max, smoothing_angle,
                           out_dir + "t4_rel_int.png", min=range_ri[0], 
                           max=range_ri[1])
