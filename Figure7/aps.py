...
if __name__ == "__main__":
    ...
    p.add_argument('-sy', '--syserr', dest='syserr',
            help ='Merged error bar files from sysErr.py')
    p.add_argument('-st', '--staterr', dest='staterr',
            help ='Merged error bar files from statErr.py')
    p.add_argument('-i', '--iso', dest='iso',
            help ='Merged isotropic noise band files from isoErr.py')
